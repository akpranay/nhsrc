...
{   
 ...
 if($uid==NULL OR $city==NULL OR $state==NULL OR $add==NULL OR $email==NULL OR $conc==NULL OR $typeg==NULL OR $uname==NULL  )
     {
               $errTyp = "warning";
    ...
    {
        $errTyp = "warning";
        $errMSG = "UID already registered ...";
    }
else 
    {
       
        $sql = "INSERT INTO final_preg(uid,uname,addr,state,city,gend,email,contno)
        VALUES ('$uid','$uname','$add','$state','$city','$typeg','$email','$conc')";
                    ...
                    <div class="navbar navbar-default navbar-static-top" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="logout.php?logout">Sign out </li>      
...
$hname = $hrg = $email = $website = $uname = $state = $city = $cname = $typeg = $typet = $category = "";?>              
            ...
            if ( isset($errMSG) ) {
                ...
                <a href="regp.php"><h3>Go to registration</h3></a>
                <?php
            }
            else if(isset($emg)){
                ?>
