 <?php
    ...
    if( isset($_POST['btn-login']) ) {    
        ...
        $res=mysql_query("SELECT huname, hpass FROM final_hreg  WHERE huname='$email'");
        
        $row=mysql_fetch_array($res);
        
        $count = mysql_num_rows($res); // if uname/pass correct it returns must be 1 row
        
        if( $count == 1 && $row['hpass']==$password ) {
            $_SESSION['user'] = $row['huname'];
            header("Location: home.php");
        } else {
                                    ...
                                    <form method="post" autocomplete="off">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                <span class="input-group-addon"><span class="glyphicon glyphicon-search"></span></span>
                                                <input type="text" name="email" class="form-control" placeholder="Hospital username" required />
                                                </div>
                                            </div>
